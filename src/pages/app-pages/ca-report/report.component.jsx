...
const Report = ({
  ...
  const [totalOpeExps, setTotalOpeExps] = useState(0);
  const [totalMatExps, setTotalMatExps] = useState(0);
  ...
  return (
    <div className='app-page app-page--layout ca-report-page'>
      <div className='app-page-name-section'>
        <h1 className='page-h1'>Charges Report</h1>
      ...
      <FilterBar
        ...
        setTotalOpeExps={setTotalOpeExps}
        totalMatExps={totalMatExps}
        setTotalMatExps={setTotalMatExps}
      />
